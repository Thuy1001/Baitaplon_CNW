...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 27, 2021 lúc 07:05 PM
...
CREATE TABLE `admins` (
  ...
  `com_address` varchar(150) DEFAULT NULL,
...
CREATE TABLE `payments` (
  ...
  `stk_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `payments` (`pay_id`, `item_number`, `stk_id`, `pay_gross`, `currency_code`, `pay_status`, `pro_id`) VALUES
