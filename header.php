                            ...
                            <ul class="nav justify-content-end">
                                   ...
                                   ?>
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <li><a href="../baitaplon/account/logout_user.php" class="dropdown-item nav-link" name='logout'>Đăng xuất</a></li>
                               ...
                               <?php  } else {?> 
                                <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                            <li><a href="../baitaplon/account/login.php" class="dropdown-item nav-link">Đăng nhập</a></li>
                                            <li><a href="../baitaplon/admin/index.php" class="dropdown-item nav-link">Quản trị viên</a></li>
                                        </ul>
                                </li>
                              <?php } ?>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="carts1.php"><i class="fas fa-shopping-cart"></i> Giỏ hàng</a>
                                </li>
